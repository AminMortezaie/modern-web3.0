        ...
        <nav className='w-full flex md:justify-center justify-between items-center p-4'>
            ...
            <ul className='text-white md:flex hidden list-none flex-row justify-between items-center flex-initial'>
                {["Markets", "Exchange", "Tutorials", "Wallets"].map((item, index)=>(
                    <NavbarItem key={item+ index } title={item} classProps={'hover:text-regal-blue'}/>
                ))}
            ...
            <div className='flex relative'>
                    ...
                    {toggleMenu && (
                        ...
                        >  
                            ...
                            {["Markets", "Exchange", "Tutorials", "Wallets"].map((item, index)=>(
                                <NavbarItem key={item+ index } title={item} classProps={'my-2 text-lg hover:transition duration-150 ease-in-out'}/>
                            ))}
                        </ul>
                    )
                    }
